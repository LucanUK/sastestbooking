    ...
    SAS - MOT Booking Confirm
                      ...
                      <form method="POST" action="{{ route('bookingdone') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{ $userdata['PhoneNumber'] }}" id="PhoneNumber" name="PhoneNumber" class="form-control"  readonly
                                    autofocus><br>
                            <label for="make">Email </label>
                            <input type="text" placeholder="{{ $userdata['Email'] }}" id="Email" name="Email" class="form-control"  readonly
                                            autofocus><br>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{ $vehicledata->fuelType }}" id="fuelType" name="fuelType" class="form-control"  readonly
                                            autofocus><br>
                            <label for="make">Engine Size </label>
                            <input type="text" placeholder="{{ $vehicledata->engineCapacity }}" id="engineCapacity" name="engineCapacity" class="form-control"  readonly
                                                            autofocus><br>
                            <label for="make">MOT Status </label>
                            <input type="text" placeholder="{{ $vehicledata->motStatus }}" id="motStatus" name="motStatus" class="form-control"  readonly
                                                            autofocus><br>
                            <label for="make">MOT Expiry </label>
                            <input type="text" placeholder="{{ $vehicledata->motExpiryDate }}" id="motExpiryDate" name="motExpiryDate" class="form-control"  readonly
                                                autofocus><br>
                        </div>
                        <div class="form-group mb-3">
                            <br>
